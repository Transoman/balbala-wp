...
<div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>" style="opacity: 0; transition: opacity .25s ease-in-out;">
  ...
  <div class="woocommerce-product-gallery__wrap">

    <div class="woocommerce-product-gallery__main-img">
      <div class="woocommerce-product-slider swiper-container">
        <div class="swiper-wrapper">
          <div class="woocommerce-product-slider__item swiper-slide">
            <?php
            if ( $product->get_image_id() ) {
              ...
              echo '<div data-thumb="' . esc_url( $thumbnail_src[0] ) . '" data-thumb-alt="' . esc_attr( $alt_text ) . '" class="woocommerce-product-slider__image"><a href="' . esc_url( $full_src[0] ) . '" data-fancybox="group">' . $image . '</a></div>';
            } else {
      ...
      </div><!-- /.woocommerce-product-slider -->
    </div>

    <div class="woocommerce-product-gallery__thumb">
