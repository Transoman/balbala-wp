...
function ith_enqueue_front_end_assets() {
  wp_enqueue_style( 'ith-blocks-css', get_template_directory_uri() . '/editor.css' );
}
add_action( 'enqueue_block_editor_assets', 'ith_enqueue_front_end_assets' );
